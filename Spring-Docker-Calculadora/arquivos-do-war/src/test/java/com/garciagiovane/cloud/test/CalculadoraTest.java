...
public class CalculadoraTest {
    ...
    public void testSoma(){
        Assert.assertEquals(5, calculadora.calcular(2, 3, "+"), 0);
    }

    @Test
    public void testSubtracao(){
        Assert.assertEquals(10, calculadora.calcular(17, 7, "-"), 0);
    }

    @Test
    public void testMultiplicacao(){
        Assert.assertEquals(25, calculadora.calcular(5, 5, "*"), 0);
    }

    @Test
    public void testDivisao(){
        Assert.assertEquals(2, calculadora.calcular(4, 2,"/"), 0);
    }
    ...
    public void testPotenciacao(){
        Assert.assertEquals(4, calculadora.calcular(2, 2, "^"), 0);
    }
    ...
    public void testHistorico(){
        ...
        Assert.assertEquals(10, calculadora.mostrarHistorico().get(0).calcular(), 0);
        Assert.assertEquals(15, calculadora.mostrarHistorico().get(2).calcular(), 0);
        Assert.assertEquals(2, calculadora.mostrarHistorico().get(4).calcular(), 0);
        Assert.assertEquals(50, calculadora.mostrarHistorico().get(6).calcular(), 0);
        Assert.assertEquals(4, calculadora.mostrarHistorico().get(8).calcular(), 0);
    }
}