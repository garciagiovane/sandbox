...
@SpringBootTest(classes = ClienteTwitter.class, webEnvironment = WebEnvironment.RANDOM_PORT)
public class TwitterApplicationTests {
    ...
    public void testResultadoOK() throws Exception {
    	assertThat(this.testRestTemplate.getForObject("http://localhost:" + port + "/twitter/garciagiovane", String.class)).contains("{\"tweets\":\"880\"}");
    }
